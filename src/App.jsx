  ...
  return (
    <div style={{ backgroundColor: baseTheme.cream, color: baseTheme.ink, minHeight: '100vh' }}>
      <section className="relative overflow-hidden bg-[#0C1712]">
        ...
        <div className="relative mx-auto max-w-6xl px-6 pb-24 pt-24 md:px-10 md:pt-32 lg:px-0">
...
function Hero({ app }) {
  ...
  return (
    <section className="relative h-[100dvh] overflow-hidden" style={{ backgroundColor: theme.ink }}>
      ...
      <div className="relative mx-auto flex h-full max-w-6xl items-end px-6 pb-16 md:px-10 md:pb-24 lg:px-0">
